...
func init() {
	...
	// inspectCmd.PersistentFlags().StringVar(&server.RPCAddr, "raddr", raddr, "Set RPC server addr (host:port)")
...
func inspect() error {
	...
	log.Info().Str("address", server.RPCAddr).Msg("Connecting to server")
